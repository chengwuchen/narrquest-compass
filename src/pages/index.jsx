...
export default function NarrQuestCompass() {
  ...
  const questions = [
    {
      id: "autonomy",
      question: "你是否具備獨立思考與自我駕馭的語氣？（1~10分）",
      type: "scale",
    },
    {
      id: "goal",
      question: "你最看重以下哪一項？",
      type: "choice",
      options: ["金錢", "生活品質", "聲譽", "社會地位"],
    },
    {
      id: "explore",
      question: "你對新鮮嘗試的渴求程度（1~10分）",
      type: "scale",
    },
    {
      id: "freedom",
      question: "你是否嚮往國外自由與活潑的學習氣氛？（1~10分）",
      type: "scale",
    },
    {
      id: "major",
      question: "你目前考慮的科系或方向為？",
      type: "input",
    },
  ];
        ...
        <Card>
          <CardContent className="space-y-4 p-4">
            ...
            <p className="text-sm text-gray-500">
              NarrQuest 鼓勵每一位探索者，成為語氣主體，打造屬於自己的敘事宇宙。
            </p>
          </CardContent>
        </Card>
      )}
